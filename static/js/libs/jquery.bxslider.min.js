...
display:"block"}));a.controls.el=d('<div class="bx-controls" />');a.settings.captions&&O();a.active.last=a.settings.startSlide===h()-1;a.settings.video&&c.fitVids();if("all"===a.settings.preloadImages||a.settings.ticker)b=a.children;a.settings.ticker?a.settings.pager=!1:(a.settings.controls&&(a.controls.next=d('<a class="bx-next" href="">'+a.settings.nextText+"</a>"),a.controls.prev=d('<a class="bx-prev" href="">'+a.settings.prevText+"</a>"),a.controls.next.bind("click touchend",D),a.controls.prev.bind("click touchend",
E),a.settings.nextSelector&&d(a.settings.nextSelector).append(a.controls.next),a.settings.prevSelector&&d(a.settings.prevSelector).append(a.controls.prev),a.settings.nextSelector||a.settings.prevSelector||(a.controls.directionEl=d('<div class="bx-controls-direction" />'),a.controls.directionEl.append(a.controls.prev).append(a.controls.next),a.controls.el.addClass("bx-has-controls-direction").append(a.controls.directionEl))),a.settings.auto&&a.settings.autoControls&&(a.controls.start=d('<div class="bx-controls-auto-item"><a class="bx-start" href="">'+
a.settings.startText+"</a></div>"),a.controls.stop=d('<div class="bx-controls-auto-item"><a class="bx-stop" href="">'+a.settings.stopText+"</a></div>"),a.controls.autoEl=d('<div class="bx-controls-auto" />'),a.controls.autoEl.on("click",".bx-start",P),a.controls.autoEl.on("click",".bx-stop",Q),a.settings.autoControlsCombine?a.controls.autoEl.append(a.controls.start):a.controls.autoEl.append(a.controls.start).append(a.controls.stop),a.settings.autoControlsSelector?d(a.settings.autoControlsSelector).html(a.controls.autoEl):
a.controls.el.addClass("bx-has-controls-auto").append(a.controls.autoEl),u(a.settings.autoStart?"stop":"start")),a.settings.pager&&(a.settings.pagerCustom?a.pagerEl=d(a.settings.pagerCustom):(a.pagerEl=d('<div class="bx-pager" />'),a.settings.pagerSelector?d(a.settings.pagerSelector).html(a.pagerEl):a.controls.el.addClass("bx-has-pager").append(a.pagerEl),F()),a.pagerEl.on("click touchend","a",R)),(a.settings.controls||a.settings.autoControls||a.settings.pager)&&a.viewport.after(a.controls.el));S(b,
T)},S=function(a,c){var e=a.find('img:not([src=""]), iframe').length,k=0;0===e?c():a.find('img:not([src=""]), iframe').each(function(){d(this).one("load error",function(){++k===e&&c()}).each(function(){this.complete&&d(this).load()})})},T=function(){if(a.settings.infiniteLoop&&"fade"!==a.settings.mode&&!a.settings.ticker){var b="vertical"===a.settings.mode?a.settings.minSlides:a.settings.maxSlides,g=a.children.slice(0,b).clone(!0).addClass("bx-clone"),b=a.children.slice(-b).clone(!0).addClass("bx-clone");
a.settings.ariaHidden&&(g.attr("aria-hidden",!0),b.attr("aria-hidden",!0));c.append(g).prepend(b)}a.loader.remove();G();"vertical"===a.settings.mode&&(a.settings.adaptiveHeight=!0);a.viewport.height(q());c.redrawSlider();a.settings.onSliderLoad.call(c,a.active.index);a.initialized=!0;a.settings.responsive&&d(window).bind("resize",v);a.settings.auto&&(a.settings.autoStart&&(1<h()||a.settings.autoSlideForOnePage))&&U();a.settings.ticker&&V();a.settings.pager&&w(a.settings.startSlide);a.settings.controls&&
H();a.settings.touchEnabled&&!a.settings.ticker&&W();a.settings.keyboardEnabled&&!a.settings.ticker&&d(document).keydown(I)},q=function(){var b=0,c=d();if("vertical"===a.settings.mode||a.settings.adaptiveHeight)if(a.carousel){var e=1===a.settings.moveSlides?a.active.index:a.active.index*m(),c=a.children.eq(e);for(i=1;i<=a.settings.maxSlides-1;i++)c=e+i>=a.children.length?c.add(a.children.eq(i-1)):c.add(a.children.eq(e+i))}else c=a.children.eq(a.active.index);else c=a.children;"vertical"===a.settings.mode?
...
a.settings.mode&&l(-b.top,"reset",0)))},l=function(b,g,e,k){var f;a.usingCSS?(b="vertical"===a.settings.mode?"translate3d(0, "+b+"px, 0)":"translate3d("+b+"px, 0, 0)",c.css("-"+a.cssPrefix+"-transition-duration",e/1E3+"s"),"slide"===g?(c.css(a.animProp,b),0!==e?c.bind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",function(a){d(a.target).is(c)&&(c.unbind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd"),s())}):s()):"reset"===g?c.css(a.animProp,b):"ticker"===g&&
(c.css("-"+a.cssPrefix+"-transition-timing-function","linear"),c.css(a.animProp,b),0!==e?c.bind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",function(a){d(a.target).is(c)&&(c.unbind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd"),l(k.resetValue,"reset",0),r())}):(l(k.resetValue,"reset",0),r()))):(f={},f[a.animProp]=b,"slide"===g?c.animate(f,e,a.settings.easing,function(){s()}):"reset"===g?c.css(a.animProp,b):"ticker"===g&&c.animate(f,e,"linear",function(){l(k.resetValue,
"reset",0);r()}))},F=function(){for(var b="",c="",e=h(),k=0;k<e;k++)a.settings.buildPager&&d.isFunction(a.settings.buildPager)||a.settings.pagerCustom?(c=a.settings.buildPager(k),a.pagerEl.addClass("bx-custom-pager")):(c=k+1,a.pagerEl.addClass("bx-default-pager")),b+='<div class="bx-pager-item"><a href="" data-slide-index="'+k+'" class="bx-pager-link">'+c+"</a></div>";a.pagerEl.html(b)},O=function(){a.children.each(function(a){a=d(this).find("img:first").attr("title");void 0!==a&&(""+a).length&&d(this).append('<div class="bx-caption"><span>'+
...
"";0===a.active.index?b=a.children.eq(0).position():a.active.index===h()-1&&a.carousel?b=a.children.eq((h()-1)*m()).position():a.active.index===a.children.length-1&&(b=a.children.eq(a.children.length-1).position());b&&("horizontal"===a.settings.mode?l(-b.left,"reset",0):"vertical"===a.settings.mode&&l(-b.top,"reset",0))}a.working=!1;a.settings.onSlideAfter.call(c,a.children.eq(a.active.index),a.oldIndex,a.active.index)},u=function(b){a.settings.autoControlsCombine?a.controls.autoEl.html(a.controls[b]):
(a.controls.autoEl.find("a").removeClass("active"),a.controls.autoEl.find("a:not(.bx-"+b+")").addClass("active"))},H=function(){1===h()?(a.controls.prev.addClass("disabled"),a.controls.next.addClass("disabled")):!a.settings.infiniteLoop&&a.settings.hideControlOnEnd&&(0===a.active.index?(a.controls.prev.addClass("disabled"),a.controls.next.removeClass("disabled")):a.active.index===h()-1?(a.controls.next.addClass("disabled"),a.controls.prev.removeClass("disabled")):(a.controls.prev.removeClass("disabled"),
a.controls.next.removeClass("disabled")))},U=function(){0<a.settings.autoDelay?setTimeout(c.startAuto,a.settings.autoDelay):(c.startAuto(),d(window).focus(function(){c.startAuto()}).blur(function(){c.stopAuto()}));a.settings.autoHover&&c.hover(function(){a.interval&&(c.stopAuto(!0),a.autoPaused=!0)},function(){a.autoPaused&&(c.startAuto(!0),a.autoPaused=null)})},V=function(){var b=0,g,e,k,f,h,m,n;"next"===a.settings.autoDirection?c.append(a.children.clone().addClass("bx-clone")):(c.prepend(a.children.clone().addClass("bx-clone")),
...
e=a.children.first().position();l("horizontal"===a.settings.mode?-d.left:-d.top,"ticker",b,{resetValue:"horizontal"===a.settings.mode?-e.left:-e.top})},I=function(a){var g=document.activeElement.tagName.toLowerCase();if(g=null==RegExp(g,["i"]).exec("input|textarea")){var e=d(window),g=e.scrollTop(),k=e.scrollLeft(),f,h=c.offset();f=k+e.width();e=g+e.height();h.right=h.left+c.outerWidth();h.bottom=h.top+c.outerHeight();g=!(f<h.left||k>h.right||e<h.top||g>h.bottom)}if(g){if(39===a.keyCode)return D(a),
...
("horizontal"===a.settings.mode?(f=c[0].pageX-a.touch.start.x,f=a.touch.originalPos.left+f):(f=c[0].pageY-a.touch.start.y,f=a.touch.originalPos.top+f),l(f,"reset",0))},y=function(b){a.viewport.unbind("touchmove MSPointerMove pointermove",x);a.controls.el.removeClass("disabled");b=b.originalEvent;b="undefined"!==typeof b.changedTouches?b.changedTouches:[b];var d=0,e=0;a.touch.end.x=b[0].pageX;a.touch.end.y=b[0].pageY;"fade"===a.settings.mode?(e=Math.abs(a.touch.start.x-a.touch.end.x),e>=a.settings.swipeThreshold&&
(a.touch.start.x>a.touch.end.x?c.goToNextSlide():c.goToPrevSlide(),c.stopAuto())):("horizontal"===a.settings.mode?(e=a.touch.end.x-a.touch.start.x,d=a.touch.originalPos.left):(e=a.touch.end.y-a.touch.start.y,d=a.touch.originalPos.top),!a.settings.infiniteLoop&&(0===a.active.index&&0<e||a.active.last&&0>e)?l(d,"reset",200):Math.abs(e)>=a.settings.swipeThreshold?(0>e?c.goToNextSlide():c.goToPrevSlide(),c.stopAuto()):l(d,"reset",200));a.viewport.unbind("touchend MSPointerUp pointerup",y);a.viewport.get(0).releasePointerCapture&&
a.viewport.get(0).releasePointerCapture(a.pointerId)},v=function(b){if(a.initialized)if(a.working)window.setTimeout(v,10);else{b=d(window).width();var g=d(window).height();if(z!==b||A!==g)z=b,A=g,c.redrawSlider(),a.settings.onSliderResize.call(c,a.active.index)}},K=function(b){var c=p();a.settings.ariaHidden&&!a.settings.ticker&&(a.children.attr("aria-hidden","true"),a.children.slice(b,b+c).attr("aria-hidden","false"))};c.goToSlide=function(b,g){var e=!0,k=0,f={left:0,top:0},e=null;a.working||(a.oldIndex=
a.active.index,a.active.index=0>b?a.settings.infiniteLoop?h()-1:a.active.index:b>=h()?a.settings.infiniteLoop?0:a.active.index:b,a.active.index!==a.oldIndex&&(a.working=!0,e=a.settings.onSlideBefore.call(c,a.children.eq(a.active.index),a.oldIndex,a.active.index),"undefined"===typeof e||e?("next"===g?a.settings.onSlideNext.call(c,a.children.eq(a.active.index),a.oldIndex,a.active.index)||(e=!1):"prev"===g&&(a.settings.onSlidePrev.call(c,a.children.eq(a.active.index),a.oldIndex,a.active.index)||(e=!1)),
a.active.last=a.active.index>=h()-1,(a.settings.pager||a.settings.pagerCustom)&&w(a.active.index),a.settings.controls&&H(),"fade"===a.settings.mode?(a.settings.adaptiveHeight&&a.viewport.height()!==q()&&a.viewport.animate({height:q()},a.settings.adaptiveHeightSpeed),a.children.filter(":visible").fadeOut(a.settings.speed).css({zIndex:0}),a.children.eq(a.active.index).css("zIndex",a.settings.slideZIndex+1).fadeIn(a.settings.speed,function(){d(this).css("zIndex",a.settings.slideZIndex);s()})):(a.settings.adaptiveHeight&&
a.viewport.height()!==q()&&a.viewport.animate({height:q()},a.settings.adaptiveHeightSpeed),!a.settings.infiniteLoop&&a.carousel&&a.active.last?"horizontal"===a.settings.mode?(e=a.children.eq(a.children.length-1),f=e.position(),k=a.viewport.width()-e.outerWidth()):(f=a.children.length-a.settings.minSlides,f=a.children.eq(f).position()):a.carousel&&a.active.last&&"prev"===g?(f=1===a.settings.moveSlides?a.settings.maxSlides-m():(h()-1)*m()-(a.children.length-a.settings.maxSlides),e=c.children(".bx-clone").eq(f),
f=e.position()):"next"===g&&0===a.active.index?(f=c.find("> .bx-clone").eq(a.settings.maxSlides).position(),a.active.last=!1):0<=b&&(f=b*parseInt(m()),f=a.children.eq(f).position()),"undefined"!==typeof f?(k="horizontal"===a.settings.mode?-(f.left-k):-f.top,l(k,"slide",a.settings.speed)):a.working=!1),a.settings.ariaHidden&&K(a.active.index*m())):(a.active.index=a.oldIndex,a.working=!1)))};c.goToNextSlide=function(){if(a.settings.infiniteLoop||!a.active.last){var b=parseInt(a.active.index)+1;c.goToSlide(b,
"next")}};c.goToPrevSlide=function(){if(a.settings.infiniteLoop||0!==a.active.index){var b=parseInt(a.active.index)-1;c.goToSlide(b,"prev")}};c.startAuto=function(b){a.interval||(a.interval=setInterval(function(){"next"===a.settings.autoDirection?c.goToNextSlide():c.goToPrevSlide()},a.settings.pause),a.settings.autoControls&&!0!==b&&u("stop"))};c.stopAuto=function(b){a.interval&&(clearInterval(a.interval),a.interval=null,a.settings.autoControls&&!0!==b&&u("start"))};c.getCurrentSlide=function(){return a.active.index};
c.getCurrentSlideElement=function(){return a.children.eq(a.active.index)};c.getSlideElement=function(b){return a.children.eq(b)};c.getSlideCount=function(){return a.children.length};c.isWorking=function(){return a.working};c.redrawSlider=function(){a.children.add(c.find(".bx-clone")).outerWidth(C());a.viewport.css("height",q());a.settings.ticker||G();a.active.last&&(a.active.index=h()-1);a.active.index>=h()&&(a.active.last=!0);a.settings.pager&&!a.settings.pagerCustom&&(F(),w(a.active.index));a.settings.ariaHidden&&
K(a.active.index*m())};c.destroySlider=function(){a.initialized&&(a.initialized=!1,d(".bx-clone",this).remove(),a.children.each(function(){void 0!==d(this).data("origStyle")?d(this).attr("style",d(this).data("origStyle")):d(this).removeAttr("style")}),void 0!==d(this).data("origStyle")?this.attr("style",d(this).data("origStyle")):d(this).removeAttr("style"),d(this).unwrap().unwrap(),a.controls.el&&a.controls.el.remove(),a.controls.next&&a.controls.next.remove(),a.controls.prev&&a.controls.prev.remove(),
a.pagerEl&&(a.settings.controls&&!a.settings.pagerCustom)&&a.pagerEl.remove(),d(".bx-caption",this).remove(),a.controls.autoEl&&a.controls.autoEl.remove(),clearInterval(a.interval),a.settings.responsive&&d(window).unbind("resize",v),a.settings.keyboardEnabled&&d(document).unbind("keydown",I),d(this).removeData("bxSlider"))};c.reloadSlider=function(a){void 0!==a&&(t=a);c.destroySlider();B();d(c).data("bxSlider",this)};B();d(c).data("bxSlider",this);return this}}})(jQuery);
